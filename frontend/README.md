<div align="center">
  <hr />
    <h2 align="center" style="border-bottom: none">Cardano Drep Delegator Feedback Platform</h2>
...
<h3 align="center" style="border-bottom: none"> powered by SIDAN Lab <img style="position: relative; top: 0.25rem;" src="https://raw.githubusercontent.com/sidan-lab/brand_assets/main/sidan.png" alt="sidan" height="30" /><img style="position: relative; top: 0.25rem;" src="https://meshjs.dev/logo-mesh/white/logo-mesh-white-256x256.png" alt="sidan" height="30" /></h2>

  <hr/>
</div>

Cardano Drep Delegator Feedback Platform is an open-source Cardano governance platform, it is interacting with below components:

- `api` - Core API server as backend supporting the application
- `discord` - The discord bot component of the Cardano Drep Delegator Feedback Platform

With Cardano Drep Delegator Feedback Platform, you can
